...
-- =================================================================
-- Check for NULLs or Duplication in Primary Key
...
-- Checks for NULLs or Negative Values in Cost 
-- Expectations: No Results
SELECT 
  prd_cost
FROM silver.crm_prd_info
...
-- Expectations: Birth dates between 1924-01-01 and Today 
SELECT DISTINCT 
  bdate 
