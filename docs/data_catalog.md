...
| subcategory          | NVARCHAR(50)  | A more detailed classification within the category, providing a finer level of grouping. |
| maintenance_required | NVARCHAR(50)  | Indicates whether the product requires maintenance (e.g., 'Yes'). |
| cost                 | INT           | The cost or base price of the product, measured in monetary units. |
| product_line         | NVARCHAR(50)  | The specific product line or series to which the product belongs (e.g., 'Road'). |
...
| sales_amount  | INT           | The total monetary value of the sale for the line item (e.g., 1). |
| quantity      | INT           | The number of units sold for the line item. |
